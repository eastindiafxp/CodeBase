...
<head>
    <title>仪表盘</title>
    <jsp:include page="../mainFrame/head.jsp"/>
</head>
<body>
                            ...
                            <div class="table-responsive">
                                <table id="data-table" class="table text-nowrap mb-0 table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(resources/images/users/11.jpg)"></span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(resources/images/users/12.jpg)"></span>
                                                <div class="user-details ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(resources/images/users/13.jpg)"></span>
                                                <div class="user-details ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(resources/images/users/4.jpg)"></span>
                                                <div class="user-details ms-2">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span class="data-image avatar avatar-md rounded-circle" style="background-image: url(resources/images/users/5.jpg)"></span>
                                                <div class="user-details ms-2">
